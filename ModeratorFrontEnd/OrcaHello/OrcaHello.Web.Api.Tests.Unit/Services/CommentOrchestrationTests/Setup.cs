namespace OrcaHello.Web.Api.Tests.Unit.Services
{
    ...
    public partial class CommentOrchestrationTests
    {
        ...
        private readonly Mock<ILogger<CommentOrchestrationService>> _loggerMock;

        private readonly ICommentOrchestrationService _orchestrationService;

        public CommentOrchestrationTests()
        {
            _metadataServiceMock = new Mock<IMetadataService>();
            _loggerMock = new Mock<ILogger<CommentOrchestrationService>>();

            _orchestrationService = new CommentOrchestrationService(
