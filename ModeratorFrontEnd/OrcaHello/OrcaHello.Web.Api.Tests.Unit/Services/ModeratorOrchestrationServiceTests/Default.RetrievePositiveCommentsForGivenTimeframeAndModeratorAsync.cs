    ...
    public partial class ModeratorOrchestrationServiceTests
    {
        ...
        public async Task Default_RetrievePositiveCommentsForGivenTimeframeAndModeratorAsync_Expect()
        {
            ...
            _metadataServiceMock.Setup(service =>
                service.RetrievePositiveMetadataForGivenTimeframeAndModeratorAsync(It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<string>(), It.IsAny<int>(), It.IsAny<int>()))
                .ReturnsAsync(expectedResults);

            CommentListResponse result = await _orchestrationService.RetrievePositiveCommentsForGivenTimeframeAndModeratorAsync(DateTime.Now, DateTime.Now.AddDays(1), "Moderator", 1, 10);
