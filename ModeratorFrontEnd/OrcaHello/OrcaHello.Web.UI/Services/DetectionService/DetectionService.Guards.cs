namespace OrcaHello.Web.UI.Services
{
    ...
    public partial class DetectionService
    {
        ...
        protected static void Validate(string propertyValue, string propertyName)
        {
        ...
        protected static void Validate(DateTime? date, string propertyName)
        {
        ...
        protected static void ValidateAtLeastOneId(List<string> items, string propertyName)
        {
        ...
        protected static void ValidateDateRange(DateTime? fromDate, DateTime? toDate)
        {
            ...
            if (toDate.HasValue && toDate.Value < fromDate)
                throw new InvalidDetectionException("Property 'toDate' cannot be before the 'fromDate' date.");
        }

        // RULE: Pagination must be correct.
        protected static void ValidatePagination(int page, int pageSize)
        {
            if (page <= 0)
